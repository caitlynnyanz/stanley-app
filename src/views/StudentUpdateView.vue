...
<template>
  <div>
    ...
    <div class="container">
      ...
      <form v-on:submit.prevent="editStudent()">
        ...
        <div>
          Company Name:
          <input type="text" v-model="student.experience[0].company_name" />
        </div>
        <div>
          Start Date:
          <input type="text" v-model="student.experience[0].start_Date" />
        </div>
        <div>
          End Date:
          <input type="text" v-model="student.experience[0].end_date" />
        </div>
        <div>
          Details:
          <input type="textarea" v-model="student.experience[0].details" />
        </div>
        <input type="submit" value="Update Student Info" class="btn btn-primary" />
      </form>
    </div>
  ...
  <div class="container">
    ...
    <form v-on:submit.prevent="editStudent()">
      ...
      <div>
        University Name:
        <input type="text" v-model="student.education[0].university_name" />
      </div>
      <div>
        Degree:
        <input type="text" v-model="student.education[0].degree" />
      </div>
      <div>
        Start Date:
        <input type="text" v-model="student.education[0].start_date" />
      </div>
      <div>
        End Date:
        <input type="text" v-model="student.education[0].end_date" />
      </div>
      <div>
        Details:
  ...
  <div class="container">
    ...
    <form v-on:submit.prevent="editStudent()">
      ...
      <div>
        Skill:
        <input type="text" v-model="student.skills[0].skills_name" />
      </div>
      <input type="submit" value="Update Student Info" class="btn btn-primary" />
    </form>
  </div>
